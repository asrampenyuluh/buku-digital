      ...
      <div className="flex gap-space-md items-start relative z-10">
        <div className="relative shrink-0 w-24 h-32 rounded bg-primary-container p-1 shadow-md flex flex-col justify-between overflow-hidden">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBcnM1Or1eo_-YfHzoWL4DgkH9zwn1yzpDb1tyTOnObgrzjcezK2_UYNBlzezuuUxYkIxAuYjpD5Pnb8kWJulFtMW15_NykLaoOjDv_54cYoWQ1xVKMcoH2LNiION61Cs_y7WOMinorDVYxfDFe9DeR8wrOXVnCqcigG2dCKz15LUVZKUx2NI_6skCIB9_lrtJMaS34by_UP1hHezVydLxorjxmAdHim_esOFGsKZxXDdHX5FBJXn4ROg')"
            }}
          ></div>
